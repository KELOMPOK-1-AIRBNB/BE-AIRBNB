...
import (
	user "github.com/KELOMPOK-1-AIRBNB/BE-AIRBNB/features/user"
...
// UpdateRole provides a mock function with given fields: id, input
func (_m *UserData) UpdateRole(id uint, input user.Core) error {
	ret := _m.Called(id, input)
